...
export function AppSettingsEditor(props: {
  ...
  const { value, onChange, onExport, onImport, onExportCsv, onImportCsv, onImportJsonText, onImportCsvText, currentTheme, onToggleTheme } = props;
  ...
  return (
    <div className="space-y-3 text-sm">
      ...
      <div className="flex flex-wrap items-center gap-2">
        <button className={classNames(btnBase, btnNeutral)} onClick={save}>Save</button>
        {onToggleTheme && (
